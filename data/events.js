...
const content = () => {
  const eventArr = [
    ...
    ['Convocation Ceremony', 'General'], ['Inaugural Lectures', 'Seminar'], ['Association Convention', 'Departmental'], ['Outing Day', 'Departmental'], ['Jogging Day', 'Sports'],
    ['General Elections', 'General'], ['Association Elections', 'Departmental'], ['Association Week', 'Socials, Sports'], ['Exam Ethics Seminar', 'Ethics'], ['Association Prays Week', 'Spiritual'],
    ['Projects Week', 'Projects'], ['Uniforms Week', 'Departmental'], ['Exhibitions Day', 'Faculty'], ['Burn-Fire Day', 'Departmental'], ['Weekend Tutorials', 'Departmental'], ['Department Seminar', 'Seminar'],
  ...
  for (let i = 1; i <= 30; i++) {
    ...
    events.push(
      new Event(
        ...
        eventItem[0],
        eventItem[1],
        dateArg.toDateString(),
        (isPM && !isNoon ? +dateArg.getHours() - 12 : +dateArg.getHours()).toString() + ':' + ['00', '30', '45'][(+Math.random() * (2)).toFixed(0)] + (isPM || isNoon? 'pm' : 'am'),
        venue[(+Math.random() * 3).toFixed(0)],
