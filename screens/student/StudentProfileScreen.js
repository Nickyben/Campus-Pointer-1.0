...
const StudentProfileScreen = ({ navigation }) => {
	...
	const presentCourses = useSelector((state) => state.dataReducer.availableCourses).filter(
		(c) => c.courseLevel === +studentUser.level
	);
	...
	const {
		...
		faculty,
		image,
	} = studentUser ? studentUser : {}; //presentCourses
	const details = [
				...
				<View style={{ ...styles.row, ...styles.courseActionsRow }}>
					...
					<View style={styles.courseActions}>
						<View style={styles.courseActionContainer}>
							<TouchCard
								disableCard
								onTouch={selectOptionHandler.bind(this, 'CourseApplications', {
									title: 'Register',
									studentId: id,
								})}
						...
						<View style={styles.courseActionContainer}>
							<TouchCard
								...
								<View style={styles.actionIconContainer}>
									<Ionicons
										name={
											Platform.OS === 'android' ? 'md-checkmark-circle' : 'ios-checkmark-circle'
										}
										size={50}
										color={Colors.primary}
									/>
				...
				<View style={{ ...styles.row, ...styles.courseActionsRow, borderBottomWidth: 0 }}>
					...
					<View
						...
						<SelectOption
							...
							icon="analytics"
							color={'#ffdd15'}
							onSelect={selectOptionHandler.bind(this, 'StudentReports', {
								title: 'Results',
								studentId: id,
							})}
						/>
